...
type ChatClient interface {
	Join(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (Chat_JoinClient, error)
	Send(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (*ServerMessage, error)
}
...
func (c *chatClient) Join(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (Chat_JoinClient, error) {
...
func (x *chatJoinClient) Recv() (*ServerMessage, error) {
	m := new(ServerMessage)
...
func (c *chatClient) Send(ctx context.Context, in *ClientMessage, opts ...grpc.CallOption) (*ServerMessage, error) {
...
type ChatServer interface {
	Join(*ClientMessage, Chat_JoinServer) error
	Send(context.Context, *ClientMessage) (*ServerMessage, error)
...
func (UnimplementedChatServer) Join(*ClientMessage, Chat_JoinServer) error {
	return status.Errorf(codes.Unimplemented, "method Join not implemented")
}
func (UnimplementedChatServer) Send(context.Context, *ClientMessage) (*ServerMessage, error) {
...
func (x *chatJoinServer) Send(m *ServerMessage) error {
...
func _Chat_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).Send(ctx, req.(*ClientMessage))
	}
